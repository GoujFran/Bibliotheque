...
public class MyOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE episodes (title TEXT , year TEXT, rated TEXT, released TEXT, season TEXT, episode TEXT, runtime TEXT, genre TEXT, director TEXT, writer TEXT, actors TEXT, plot TEXT,country TEXT," +
                "awards TEXT, poster TEXT, metascore TEXT, imdbRating TEXT,  imdbID TEXT PRIMARY KEY, serieID TEXT)");
    }
